...
//     constructor(opts = {}) {
//         super();
//         const validProviders = ['hubtel', 'africasTalking', 'mikashboks'];
...
//                 Type: 'Response',
//             };
//         } else if (this.provider === 'mikashboks') {
//             this.result = {
//                 response,
//                 hasNext: true,
//             };
...
//             getAll: (cb) => {
//                 return new Promise((resolve, reject) => {
//                     let res = config.getAll(this.args.sessionId, makeCb(resolve, reject, cb));
//                     resolveIfPromise(res, resolve, reject, cb);
//                 });
//             },
//         };
